    ...
    <div className='feature-section'>
        ...
        <div className="feature-section-grid">
            ...
            <a href="#">
                <div className="feature-section-card">
                    <div className="feature-card-text">
                        <h3>Automated, recurring payments</h3>
                        <p>Automatically collect payments on the due date via Direct Debit. 
                            Even if the dates or amounts change. Perfect for subscriptions,
                            membership fees,
                            instalments, and even invoicing for services.</p>
                            <span className="how-it-works">See how it works <FiArrowRight size={20}/></span>
                    </div>
